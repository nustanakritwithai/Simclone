...
|---|---|---|
| UX legibility | **V0.6–V0.8 released; V0.9 candidate:** visual-first world reactions + visual interiors for Main/People/Survival/Rust/Systems/Decision menus | Prove every world cue reuses authoritative evidence, primary menu actions remain reachable, Knowledge controls stay immediately actionable, long copy is progressively disclosed, mobile has no overflow, and no simulation authority moves into UI |
