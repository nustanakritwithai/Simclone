...
|---|---|---|
| UX legibility | **V0.6–V0.7 released; V0.8 merged/pending public proof; V0.9 candidate:** icon/portrait-first Systems, Chronicle, Event Detail, Inventory and mobile Inspector | Prove visual-first surfaces keep evidence accessible, labels remain accessible, text is progressively disclosed, and no icon/image implies unsupported authority |
