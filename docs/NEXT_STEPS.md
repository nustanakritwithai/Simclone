...
|---|---|---|
| UX legibility | **V0.6–V0.8 released; V0.9 candidate:** visual-first world/menu UI + direct Camp/Table/Furnace/House context menus | Prove world taps resolve the correct structure, building actions are absent from Survival/global Rust duplicates, command authority remains unchanged, House status uses canonical housing evidence, mobile has no overflow, and accepted Archive/Craft/Process workflows remain reachable |
