...
| WM4 ecology authority | **WM4.7 candidate:** WM4.5 food + WM4.6 wood ecology now add depletion-derived harvest pressure through the same single writer | Prove pressure thresholds, renewable recovery, legacy A/B compatibility and replay; then shadow resource zones (WM4.8). Do not reselect the food formula |
