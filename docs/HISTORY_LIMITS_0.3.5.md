...
- Living gameplay capacity remains min(housing, 36). Retained capacity is 1024 total identities; archive JSON budget is 2300000 JavaScript string code units. Whole-save serialize/restore budget is 2500000 code units. The previous 1800000/2000000 archive/save envelope became too small under the autonomous-housing demographic path; this hotfix raises both bounded guards while preserving the original 200000-character whole-save margin. These are not UTF-8 bytes or a promise about browser quota.
