...
with sync_playwright() as p:
 ...
 check('Rust Survival panel is disclosed','Rust Survival · RS1–RS4' in page.locator('#dialog-body').inner_text())
 page.locator('#dialog-close').tap();page.locator('[data-nav="people"]').tap();page.locator('[data-person="2"]').tap()
 page.locator('#menu').tap();page.locator('[data-action="survival"]').tap()
