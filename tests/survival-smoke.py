...
with sync_playwright() as p:
 ...
 page.set_content(HTML,wait_until='load');page.wait_for_function("window.simclone?.version==='0.3.2'")
 ...
 check('shared-stock and autonomous-birth rules disclosed','คลังรวม' in page.locator('#dialog-body').inner_text() and 'สถานะการเกิดอัตโนมัติ' in page.locator('#dialog-body').inner_text() and 'parent คนเดิมพัก 4 ปี' in page.locator('#dialog-body').inner_text())
