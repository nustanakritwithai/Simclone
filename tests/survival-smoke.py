...
with sync_playwright() as p:
 ...
 page.set_content(HTML,wait_until='load');page.wait_for_function("window.simclone?.version==='0.4.0'")
 page.wait_for_selector('#boot-screen',state='detached');page.wait_for_timeout(500);page.locator('#pause').tap()
 check('old world migrates into lifecycle save schema',page.evaluate('simclone.snapshot().version')=='0.4.0')
