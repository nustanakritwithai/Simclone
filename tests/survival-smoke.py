...
with sync_playwright() as p:
 ...
 check('dedicated Rust dock opens the item catalog',page.locator('#dialog-title').inner_text()=='ไอเทมและการคราฟต์' and page.locator('[data-rust-catalog-item]').count()==9)
 ...
 check('selected Clone exposes nine bounded craft recipes',page.locator('[data-ux="craft-item"]').count()==9)
