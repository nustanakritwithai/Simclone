...
test('V0.4.0 retains the historical lifecycle sub-schema',()=>{
  assert.equal(VERSION,'0.4.0');
  assert.equal(SAVE_VERSION,'0.4.0');
...
test('0.2.0 migration recovers death facts from retained evidence',()=>{
  ...
  for(const x of raw.agents){delete x.death;delete x.skillProvenance;}
