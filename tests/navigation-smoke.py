...
with sync_playwright() as p:
 ...
 saved=m.evaluate('localStorage.getItem("simclone:world:v1")');check('saved bytes declare the migrated archive schema',json.loads(saved)['version']=='0.3.0')
...
from history_ui import run_archive_ui
run_archive_ui()

# Separate evidence scope: real loopback HTTP, native localStorage and on-disk profile restart.
from history_storage import run_native_storage
run_native_storage()
