...
"""
    ...
    with sync_playwright() as p:
        ...
        page.locator('.resources [role="button"]').click()
        check('opening knowledge controls does not alter the world',snap(page)==before)
        ...
        page.locator('[data-ux="planning-policy"]').click()
        ...
        person(page,data['reader']);page.locator('.resources [role="button"]').click()
        page.locator('details').filter(has=page.locator('[data-ux="read-archive"]')).locator('summary').click()
