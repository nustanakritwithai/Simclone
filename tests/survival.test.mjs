...
test('engine version advances while lifecycle save schema stays stable',()=>{assert.equal(VERSION,'0.3.3');assert.equal(createWorld().version,SAVE_VERSION);assert.equal(SAVE_VERSION,'0.2.0');});
