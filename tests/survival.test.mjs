...
test('engine version advances while lifecycle save schema stays stable',()=>{assert.equal(VERSION,'0.5.0');assert.equal(createWorld().version,SAVE_VERSION);assert.equal(SAVE_VERSION,'0.5.0');});
