...
export function installIndependentUI(api){
 ...
 function update(){
  ...
  const lifeHtml=life?'<div class="autonomous-life-summary" data-autonomous-life="'+a.id+'"><small>Autonomous Life · VAL1</small><span>ตอนนี้ <b>'+esc(life.currentAction?.label??'ยังไม่มีงานปัจจุบัน')+'</b></span><span>แผนบ้าน <b>'+esc(life.homePlan.label)+'</b></span>'+lifePressure+lifeWhy+'</div>':'';
