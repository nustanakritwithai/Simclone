...
import {WORLD_HYDROLOGY_VERSION,createWorldHydrology,stepWorldHydrology,validateWorldHydrology} from './worldsim-hydrology.mjs?v=0.5.0';
import {WORLD_CLIMATE_VERSION,createWorldClimate,stepWorldClimate,validateWorldClimate} from './worldsim-climate.mjs?v=0.5.0';
